...
mediawiki_api_endpoint = 'http://localhost:8181/w/api.php'

# SPARQL endpoint
wikibase_sparql_endpoint = 'http://localhost:8282/'

# Name of the Wikibase instance
wikibase_name = 'mu'

# URL of the main page of the Wikibase instance
wikibase_main_page = 'http://localhost:8181/wiki/Main_Page'
...
import re
q_re = re.compile(r'(<http://localhost:8181/(entity/|wiki/Item:))?(Q[0-9]+)>?')
q_re_group_id = 3
p_re = re.compile(r'(<http://localhost:8181/(entity/|wiki/Property:))?(P[0-9]+)>?')
p_re_group_id = 3
...
identifier_space = 'http://localhost:8181/entity/'
schema_space = 'http://localhost:8181/prop/direct/'
...
qid_url_pattern = 'https://www.wikidata.org/wiki/Item:{{id}}'
